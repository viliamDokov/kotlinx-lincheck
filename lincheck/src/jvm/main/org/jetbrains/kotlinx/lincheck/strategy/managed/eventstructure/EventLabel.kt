...
class InitializationLabel(
    ...
    private val _objectsAllocations =
        HashMap<ObjectNumber, ObjectAllocationLabel>()

    val objectsAllocations: Map<ObjectNumber, ObjectAllocationLabel>
        get() = _objectsAllocations

    val externalObjects: Set<ObjectNumber>
    ...
    fun trackExternalObject(className: String, objID: ObjectNumber) {
...
data class ObjectAllocationLabel(
    ...
    override val objectID: ObjectNumber,
    val memoryInitializer: MemoryIDInitializer,
 ...
 */
fun InitializationLabel.asObjectAllocationLabel(objID: ObjectNumber): ObjectAllocationLabel? =
 ...
 */
fun EventLabel.asObjectAllocationLabel(objID: ObjectNumber): ObjectAllocationLabel? = when (this) {
...
data class LockLabel(
    override val kind: LabelKind,
    override val mutexID: ObjectNumber,
 ...
 */
fun InitializationLabel.asUnlockLabel(mutexID: ObjectNumber) =
 ...
 *   or null if there is no external mutex object with given id exists.
 */
fun ObjectAllocationLabel.asUnlockLabel(mutexID: ObjectNumber) =
 ...
 *
 */
fun EventLabel.asUnlockLabel(mutexID: ObjectNumber): UnlockLabel? = when (this) {
 ...
 *
 */
fun EventLabel.asNotifyLabel(mutexID: ObjectNumber): NotifyLabel? = when (this) {
